...
const placeholders = {
  abstract: 'data:image/svg+xml;base64,',
  pattern: 'data:image/svg+xml;base64,'
}
</script>
...
<template>
  ...
  <Hero sectionKey="hero_2" layout="centered" height="screen" class="relative overflow-hidden">
    ...
    <HeroContent class="relative z-10" padding="md">
      ...
      <HeroActions>
        <Button variant="default" class="rounded-full my-8 py-6 px-10">Claim Offer</Button>
      </HeroActions>
    </HeroContent>
  </Hero>
  ...
  <Hero sectionKey="hero_4" layout="centered" height="screen" background="overlay">
    <HeroContent class="relative z-10" padding="md">
      ...
      <HeroActions>
        <Button variant="default" class="rounded-full my-8 py-6 px-10">
          Claim Offer
        </Button>
      </HeroActions>
    </HeroContent>
